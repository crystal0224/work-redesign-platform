...
interface Step9AIConsultantProps {
  tasks: ExtractedTask[];
  workshopId: string;
...
export default function Step9AIConsultant({ tasks, workshopId, onComplete, onPrevious }: Step9AIConsultantProps) {
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/80 backdrop-blur-sm border border-purple-200/50 rounded-full mb-6">
            <span className="text-xs font-medium text-purple-700 uppercase tracking-wide">Step 9</span>
          </div>
